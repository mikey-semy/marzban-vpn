...
> Опциональный вариант для HA / нескольких нод. В отличие от дефолтной одноузловой
> установки (SQLite, без БД-контейнера), этот сценарий по-прежнему использует MySQL.

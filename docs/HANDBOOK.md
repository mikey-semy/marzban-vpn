...
> **Полный onboarding workflow** для новых узлов (создание юзера, отправка ссылок, отслеживание оплаты) — в [ONBOARDING.md](ONBOARDING.md).
> **Шаблон приглашения** для отправки другу — в [INVITE_TEMPLATE.md](INVITE_TEMPLATE.md).
>
